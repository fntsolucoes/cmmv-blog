...
const headData = ref({
    title: settings.value?.title || 'Guru Ofertas - Economize em suas compras online',
    meta: [
        ...
        { property: 'og:title', content: settings.value?.title || 'Guru Ofertas - Economize em suas compras online' },
