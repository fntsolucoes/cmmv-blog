        ...
        <div class="w-full max-w-[1200px] mx-auto px-4 py-8">
            <div class="bg-white rounded-lg p-6">
                ...
                <div v-if="!isSearching && searchQuery.length < 2">
                    ...
                    <div class="bg-[#adadb0] text-white py-3 px-4 rounded-md flex flex-wrap justify-center gap-2 mb-6">
                        <a
...
const headData = computed(() => ({
    ...
    meta: [
        {
            name: 'description',
            content: 'Encontre cupons de desconto e ofertas por categorias. Economize em suas compras com nossos códigos promocionais organizados por tipo de produto ou serviço.'
        },
        {
            property: 'og:title',
            content: 'Cupons de Desconto por Categorias | ' + (settings.value?.['blog.title'] || 'Site de Cupons')
        },
        {
        ...
        {
            property: 'og:url',
            content: `${settings.value?.['blog.url'] || 'https://oferta.guru'}/cupom`
        }
    ],
    script: [
        {
