<template>
    <div class="font-sans bg-gray-50">
        <!-- Header -->
        <header class="bg-[#adadb0] shadow-md fixed top-0 left-0 right-0 z-50">
        ...
        <section class="py-12 bg-white border-t border-gray-200">
            <div class="container mx-auto px-4 text-center">
                ...
                <form @submit.prevent="subscribeNewsletter" class="max-w-md mx-auto flex" aria-label="Formulário de inscrição" title="Formulário de inscrição">
                    ...
                    <button
                        type="submit"
                        class="bg-[#adadb0] text-white px-6 py-3 rounded-r-lg hover:bg-indigo-700"
        ...
        <footer class="bg-gray-800 text-white pt-12 pb-6">
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
                    <!-- Sobre -->
                    <div>
                        <h3 class="text-xl font-bold mb-4">Sobre Guru Ofertas</h3>
                ...
                <div class="border-t border-gray-700 pt-6">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <p class="text-gray-400 mb-4 md:mb-0">&copy; {{ new Date().getFullYear() }} Guru Ofertas. Todos os direitos reservados.</p>
...
useHead({
    ...
    link: [
        {
            rel: 'stylesheet',
            href: '/src/theme-ofertaguru/style.css?v=2'
        },
        {
            rel: 'icon',
            type: 'image/ico',
            href: '/src/theme-ofertaguru/favicon.ico?v=2'
        },
        ...
        { rel: 'preconnect', href: 'https://www.googletag.com/' },
        { rel: 'preconnect', href: 'https://static.oferta.guru/' },
        { rel: 'dns-prefetch', href: 'https://www.googletagmanager.com/' },
        { rel: 'dns-prefetch', href: 'https://securepubads.g.doubleclick.net' },
        { rel: 'dns-prefetch', href: 'https://static.oferta.guru/' }
    ],
