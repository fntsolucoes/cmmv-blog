...
// Função auxiliar para verificar se um ticket foi concluído/cancelado há mais de 1 dia
...
const openTickets = computed(() => {
    ...
    return result.filter(ticket => {
        ...
        // Se está concluído/cancelado mas há menos de 1 dia, ainda aparece em aberto
        return !isTicketClosedMoreThan1Day(ticket);
    });
});

// Tickets Concluídos: apenas tickets "Concluído" ou "Cancelado" há mais de 1 dia
