    ...
    <div class="space-y-6">
        ...
        <div class="bg-neutral-800 rounded-lg p-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-neutral-300 mb-2">Prioridade</label>
                    <select
        ...
        <div class="bg-neutral-800 rounded-lg overflow-hidden">
            ...
            <div v-else>
                ...
                <tbody class="bg-neutral-800 divide-y divide-neutral-700">
                        ...
                        <td class="px-4 py-3 text-sm text-white">{{ ticket.assignedTo || 'Não atribuído' }}</td>
        ...
        <div v-if="showCreateDialog" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 px-4" style="backdrop-filter: blur(4px);">
            <div class="bg-neutral-800 rounded-lg shadow-lg w-full max-w-3xl mx-auto max-h-[90vh] overflow-y-auto">
                <div class="p-6 border-b border-neutral-700 flex justify-between items-center">
                    <h3 class="text-lg font-medium text-white">Novo Ticket</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                                <option value="">Automática (baseada na descrição)</option>
                                <option value="Alta">Alta</option>
                                <option value="Normal">Normal</option>
                                <option value="Média">Média</option>
                                <option value="Baixa">Baixa</option>
                            </select>
                            <p class="mt-1 text-xs text-neutral-400">Deixe em branco para priorização automática</p>
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-neutral-300 mb-2">
                        ...
                        ></textarea>
                        <p class="mt-1 text-xs text-neutral-400">A prioridade será calculada automaticamente baseada nas palavras-chave da descrição</p>
                    </div>
            ...
            <div class="bg-neutral-800 rounded-lg shadow-lg w-full max-w-5xl mx-auto max-h-[90vh] overflow-y-auto">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-neutral-700/50 rounded-lg p-4">
                            <h4 class="text-sm font-medium text-neutral-300 mb-3">Informações Gerais</h4>
                            <div class="space-y-2 text-sm">
                                <div class="flex justify-between">
...
const createTicket = async () => {
    ...
    try {
        ...
        const payload: any = {
            ...
            ticketType: 'geral', // Tipo explícito para tickets gerais
            createdBy: userId,
        };
        ...
        await client.tickets.create(payload);
...
const loadTickets = async () => {
    loading.value = true;
    try {
        // Buscar apenas tickets gerais
        const response = await client.tickets.get({ ticketType: 'geral' });
...
watch(() => [filters.value.status, filters.value.priority, filters.value.search], () => {
