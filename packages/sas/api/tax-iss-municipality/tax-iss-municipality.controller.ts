...
@Controller("affiliation-manager/tax-iss-municipality/v2")
export class TaxIssMunicipalityController {
    @Get("")
    async getAll(@Queries() queries: any) {
        const Entity = Repository.getEntity("SasTaxIssMunicipalityEntity");
